...
if instance_exists(follow)
{
	if (follow == player)
	{
		...
		else
		{
			...
			var _x = clamp(camera_get_view_x(view), v_limitleft1, max(v_limitleft1,v_limitright1-view_width-16));
			var _y = clamp(camera_get_view_y(view), v_limittop1, max(v_limittop1,v_limitbtm1-view_height-16));
