...
draw_text(112,8,"RAY   X: "+string(x)+
				"\n        Y: "+string(y)+
				"\nG SPEED: "+string(gsp)+"\nX SPEED: "+string(xsp)+"\nY SPEED: "+string(ysp)+
				...
				"\nROTATION: "+string(rotation)+"  SPEED"+string(ability_speed)+
				"\nSWOOP TIMER: "+string(swoop_timer)+"  DIVE TIMER"+string(dive_timer)+
				"\nABILITY VALUE: "+string(air_glide_prop_2nd)+"  ABILITY TIMER"+string(ability_timer));
