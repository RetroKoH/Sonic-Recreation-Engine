function scr_player_get_floor_dist(quadrant){
	var dist;
...
function scr_player_get_left_wall_dist(quadrant){
...
function scr_player_get_ceiling_dist(quadrant){
	var dist;
...
function scr_player_get_right_wall_dist(quadrant){
	var sensorY = (!(status&STA_INAIR) && (angle < 11.25 || angle > 348.75)) ? 8 : 0;
